...
public class Task_1 {
    ...
    public static void ex3(){
        ...
        try {
            ...
            System.out.println("Массив больше допустимого размера!");
        }catch (Exception ex) {
        System.out.println("Ошибка ");
        }
    }
    ...
    public static void ex4(){
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in))){
            ...
            System.out.println("Ошибка с консолью");
        }
    ...
    public static float getFloatFromUser(BufferedReader bufferedReader){
        ...
        try {
            ...
            System.out.println("Ошибка при преобразовании значения в число с плавающей точкой");
