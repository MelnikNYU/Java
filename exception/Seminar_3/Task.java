...
public class Task {
    ...
    public static void makeRecord() throws Exception{
        ...
        if (array.length != 6){
            throw new Exception("Введено неверное число параметров");
        }
        ...
        try {
            ...
            throw new ParseException("Неверный формат введения даты", e.getErrorOffset());
        }
